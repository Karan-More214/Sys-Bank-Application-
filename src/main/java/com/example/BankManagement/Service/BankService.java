...
public class BankService {
    ...
    /**
     * ✅ FIXED: Update existing bank account - ONLY SAVES, NO DEPOSIT LOGIC
     */
    public void updateBankAccount(BankEntity account) {
        bankRepo.save(account);
        // ⚠️ NO OTHER CODE HERE - This should only save!
    }
    ...
    /**
     * ❌ REMOVED: processDeposit method - This was causing DUPLICATE deposits!
     * Deposit logic is now ONLY in BankController.confirmDeposit()
     */
    // DO NOT UNCOMMENT THIS METHOD - IT CAUSES 2X DEPOSITS
    /*
    @Transactional
    public boolean processDeposit(String email, double amount) {
        // This method is DISABLED to prevent duplicate deposits
    }
    */
    ...
    /**
     * Get all bank accounts (alternate method)
     */
    ...
    /**
     * Get bank account by ID (alternate method)
     */
    ...
    /**
     * Delete bank account by ID (alternate method)
     */
    ...
    /**
     * ❌ REMOVED: recordTransaction method - This was causing DUPLICATE transaction records!
     * Transaction recording is now ONLY in BankController
     */
    // DO NOT UNCOMMENT THIS METHOD - IT CAUSES DUPLICATE TRANSACTIONS
    /*
    public void recordTransaction(String email, String type, Double amount) {
        // This method is DISABLED to prevent duplicate transaction records
    }
    */
}